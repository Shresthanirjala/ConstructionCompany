    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">NBConstruction</h3>
                <p className="text-sm text-gray-400">Pvt Ltd</p>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              Building dreams with quality construction services since 2010. 
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-400">
                    Kathmandu, Nepal<br />
                    Kageswori Manohara-2
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-blue-400 flex-shrink-0" />
                <p className="text-gray-400">+977 9851105215</p>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-blue-400 flex-shrink-0" />
                <p className="text-gray-400">info@nbconstruction.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 NBConstruction Pvt Ltd. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
