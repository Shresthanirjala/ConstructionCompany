          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-600 mb-8">
                We're here to help you with your construction needs. Contact us using 
              ...
              <div className="mt-8">
                <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p>Interactive Map</p>
                    <p className="text-sm">New Baneshwor, Kathmandu</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            From concept to completion, we're your trusted construction partner. 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="mailto:info@nbconstruction.com"
              className="inline-block border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors duration-200"
            >
              Email Us
            </a>
          </div>
